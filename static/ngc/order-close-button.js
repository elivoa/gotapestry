// Order/CloseButton
// Time-stamp: <[order-close-button.js] Elivoa @ Wednesday, 2015-11-04 00:01:50>
...
// Note: TODO:
// 本来应该使用 t:import 来使一个页面只引用这个js一次。但是现在import功能没做好，所以临时唯一一下这个js。
// 页面还是会引入多个这个js，但是只会执行一次。

// console.log("import order-close-button.js");
// console.log( angular.module('app'));
if(!window["dir-index-var-orderCloseButton"]){
  window["dir-index-var-orderCloseButton"]=1;
  
  // console.log("dir-index:", "orderCloseButton"+(window["dir-index-var-orderCloseButton"]++));

  angular.module('app').directive(
    "orderCloseButton" ,// + (window["dir-index-var-orderCloseButton"]++),
    function ($http) {
