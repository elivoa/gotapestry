...
(function () {
  ...
  window.OrderDeliverButton = OrderDeliverButton = (function () {
    ...
    OrderDeliverButton.prototype.setExpressFix = function (ClientId, express, expressFee) {
      // console.log(".choose_express label > ", ClientId, express, " > ", expressFee);
      var selector = ["#", ClientId, "_modal .choose_express label"].join("");
      // console.log("===== Selector is: ", selector);
      return $(selector).each($.proxy(function (idx, obj) {
        var ef;
        // console.log("----------", idx, $(obj).find("input:radio").val().toLowerCase());
    ...
    OrderDeliverButton.prototype.setExpress = function (express, expressFee) {
      console.log(".choose_express label > ", express, " > ", expressFee);
