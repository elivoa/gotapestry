...
(function () {
  ...
  window.OrderPrint = OrderPrint = (function () {
    ...
    OrderPrint.prototype.refreshOrderForm = function () {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (product) {
          ...
          tr = $(this.generateTR(product, totalQuantity, totalPrice, idx++, ototalPrice).join("\n"));
          tbody.append(tr);
      ...
      footers = this.appendFooter(sumQuantity, sumPrice, osumPrice);
    ...
    OrderPrint.prototype.updateSummary = function (sumQuantity, sumPrice, osumPrice) {
      var tfoot;
    ...
    OrderPrint.prototype.generateTR = function (json, totalQuantity, totalPrice, idx, ototalPrice) {
      ...
      htmls.push("  <td valign='top' align='right' rowspan='" + nquantity + "'>");
      htmls.push("      <strong class='price'>" + totalPrice.toFixed(2) + "</strong></td>");
    ...
    OrderPrint.prototype.appendFooter = function (sumQuantity, sumPrice, osumPrice) {
      var footer;
      footer = [];
      ...
      footer.push("<td valign='top'>&nbsp;</td>");
      footer.push("<td valign='top' align='right' rowspan='1'><strong class='price'>" + priiii + "</strong></td>");
      footer.push("     <td valign='top'>&nbsp;</td>");
      footer.push(" </tr>");
      console.log('append footer', sumPrice, osumPrice)
      return footer;
    };
