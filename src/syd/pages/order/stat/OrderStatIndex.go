...
func (p *OrderStatIndex) Activate() {
...
func (p *OrderStatIndex) SetupRender() {
	// fix the pagers
	if p.PageItems <= 0 {
...
func (p *OrderStatIndex) OnTab(tab string) *exit.Exit {
...
func (p *OrderStatIndex) TabStyle(tab string) string {
...
func (p *OrderStatIndex) UrlTemplate() string {
