// Time-stamp: <[PlaceOrderIndex.go] Elivoa @ Friday, 2015-04-17 21:46:31>
package inventory
...
func (p *PlaceOrderIndex) Activate() {
...
func (p *PlaceOrderIndex) SetupRender() {
	// verify user role.
	...
	parser.And(inventory.F_Type, inventory.TypePlaceOrder)
...
// func (p *PlaceOrderIndex) ShowProduct(r *model.Inventory) string {
// 	if nil != r.Product {
...
// Events
//
// func (p *PlaceOrderIndex) Ondelete(id int64, tab string) interface{} {
