// Time-stamp: <[ClientOrderIndex.go] Elivoa @ Sunday, 2015-12-20 16:49:46>
package client
...
func (p *ClientOrderIndex) Activate() {
...
func (p *ClientOrderIndex) SetupRender() {
	// verify user role.
	...
	parser.And(inventory.F_Type, inventory.TypeClientOrder)
