...
func (s *OrderReturnsService) EntityManager() *db.Entity {
	return orderdao.EntityManager()
}

func (s *OrderReturnsService) GetOrder(id int) (*model.Order, error) {
	return orderdao.GetOrder("id", id)
}

func (s *OrderReturnsService) GetOrderByTrackingNumber(trackNumber int64) (*model.Order, error) {
	return orderdao.GetOrder("track_number", trackNumber)
}

// Update Order 的所有逻辑都在这里了；
func (s *OrderReturnsService) UpdateOrder(order *model.Order) (*model.Order, error) {
...
// 创建订单的所有逻辑都在这里
func (s *OrderReturnsService) CreateOrder(order *model.Order) (*model.Order, error) {
...
// 发货
func (s *OrderReturnsService) DeliverOrder(trackNumber int64, deliveryTrackingNumber, deliveryMethod string,
...
func (s *OrderReturnsService) ListOrders(parser *db.QueryParser, withs Withs) ([]*model.Order, error) {
...
func (s *OrderReturnsService) FillOrderSlicesWithPerson(orders []*model.Order) error {
...
//
func (s *OrderReturnsService) BatchCloseOrder(money float64, customerId int) {
...
func (s *OrderReturnsService) ChangeOrderStatus(trackNumber int64, status string) error {
